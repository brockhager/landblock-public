...
2. **Layer 2: Protocol Rules (The DAO)**
   - **Scope:** Defines data schemas, structural upgrades, and absolute neutrality constraints.
   - **Governed By:** The Landblock Protocol DAO (Token holders and Stewards).
...
### Step 1: Phase 1 (The Proto-DAO)
- **Tooling:** This written Governance Constitution + Founding Steward Multi-Sig.
...
### Step 2: Phase 2 (The Early DAO)
- **Tooling:** Aragon on Ethereum/L2.
- **Rationale:** Deploys mature, well-audited governance frameworks and voting smart contracts. Proven infrastructure to facilitate transparent voting while Kadena matures its DAO capabilities.

### Step 3: Phase 3+ (The Full DAO)
- **Tooling:** Kadena On-Chain Governance.
- **Rationale:** The ultimate end-state. Migrates all Aragon-based voting directly onto the Kadena layer to align with the core land registry infrastructure, maximizing scalability and lowering operational costs.

---

## 4. Tokenomics alignment (LDBK)
The **LDBK** token represents the governance and utility asset of the Landblock Protocol DAO. It confers three specific rights:
1. **Fee Discounts:** Reduced costs for transaction operations.
2. **Validator Staking:** Yield generation for securing the network tied to fee rewards.
3. **Governance Voting:** The exclusive right to vote on Layer 2 Protocol Rules as defined in this Constitution.
